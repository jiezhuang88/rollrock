...
this.thumb_imgsrc = imagesPath+img.src;
this.thumb = document.createElement('img');
this.thumb.src=this.thumb_imgsrc;
this.thumb.width=24;
this.thumb.height=24;
this.thumb.id = 'bar_thumb';
this.thumb.style.position="absolute";
this.thumb.style.left=0;
//this.but.appendChild(this.thumb);
...
context.drawImage(this.srcImg, 0, 0, this.w, 560);
} else {
/* ---- plain image version ---- */
...
/* ---- containers ---- */
scr = document.getElementById("screen_collection_spring");
bar = document.getElementById("bar_collection_spring");
urlInfo = document.getElementById("urlInfo_collection_spring");
resize();
/* ---- loading images ---- */
var i = 0,
o,
